...
class AikenRemoveUnusedImportIntention :
    PsiElementBaseIntentionAction(),
    PriorityAction {
    init {
        text = AikenUnusedImportsQuickFixSupport.REMOVE_UNUSED_IMPORT
    }

    override fun getFamilyName(): String = AikenUnusedImportsQuickFixSupport.REMOVE_UNUSED_IMPORT
    ...
    override fun invoke(project: Project, editor: Editor, element: PsiElement) {
        ...
        AikenUnusedImportsQuickFixSupport.applyRemoveUnusedImportIfAvailable(project, editor, file)
    }
}
