...
class KeywordHighlightingLexer(
    ...
    private fun locateToken(offset: Int) {
        ...
        tokenEnd = offset + 1
        tokenType = when (ch) {
            '{' -> languageTokenSet.lbrace
            '}' -> languageTokenSet.rbrace
            '(' -> languageTokenSet.lparen
            ')' -> languageTokenSet.rparen
            '[' -> languageTokenSet.lbracket
            ']' -> languageTokenSet.rbracket
    ...
    data class TokenSet(
        val lbrace: IElementType,
        val rbrace: IElementType,
        val lparen: IElementType,
        val rparen: IElementType,
        val lbracket: IElementType,
        val rbracket: IElementType,
